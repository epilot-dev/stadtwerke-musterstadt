      ...
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 78 78">
        <g id="water_ec">
          ...
          <g mask="url(#mask0_1_42)">
            <path d={svgPaths.p77de4f1} fill="var(--fill-0, white)" id="water_ec_2" />
          </g>
        </g>
      </svg>
    </div>
      ...
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 78 78">
        <g id="water_ec">
          ...
          <g mask="url(#mask0_1_38)">
            <path d={svgPaths.p77de4f1} fill="var(--fill-0, #222222)" id="water_ec_2" />
          </g>
        </g>
      </svg>
    </div>
...
export default function BrandGuideline() {
  return (
    <div className="bg-white relative size-full" data-name="Brand guideline">
      <div className="absolute bg-[#333] h-[300px] left-0 top-0 w-[500px]" />
      <div className="absolute bg-[#d744c2] h-[300px] left-[500px] top-0 w-[500px]" />
      <div className="absolute bg-[#deff03] h-[300px] left-[500px] top-[300px] w-[500px]" />
      <Logo />
      <Logo1 />
      <Logo2 />
      <Logo3 />
