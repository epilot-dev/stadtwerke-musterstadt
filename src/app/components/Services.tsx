...
const services = [
  ...
  {
    title: "Wallbox",
    description: "Die eigene Ladestation für Ihr E-Auto. Schnell, sicher und bequem zu Hause laden.",
    icon: PlugZap,
    color: "bg-green-100",
      ...
      <div className="container mx-auto max-w-screen-xl px-4 md:px-6">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600">
            Wir versorgen Musterstadt zuverlässig mit Energie.<br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => {
            ...
            >
              {service.image ? (
                <div className={`absolute top-0 right-0 ${service.imageSize || 'w-80 h-80 -mr-28 -mt-28'} transition-all duration-500 group-hover:scale-105 z-0 pointer-events-none opacity-60 group-hover:opacity-100`}>
                  <img 
                    src={service.image} 
                    alt={service.title} 
                ...
                <div className={`absolute top-0 right-0 w-32 h-32 rounded-bl-[100px] -mr-8 -mt-8 transition-transform group-hover:scale-110 ${service.color}`} />
              )}
              ...
              <div className="relative z-10 flex items-center font-bold text-[#222222] group-hover:text-black transition-colors">
                Mehr erfahren <ArrowRight className="ml-2 w-4 h-4 transition-transform group-hover:translate-x-1" />
              </div>
            </a>
          )})}
